package com.lyh.coolw.consumer.controller;

import com.lyh.coolw.api.CommonResult;
import com.lyh.coolw.domain.User;
...
public class ConsumerController {
    ...
    public String hello() {
        ...
        // 将ip:port改为服务名称调用即可
        ResponseEntity<String> responseEntity = restTemplate.getForEntity("http://COOLW-PROVIDER-SERVICE/provider/hello", String.class);
    ...
    public String hello2() {
        return restTemplate.getForEntity("http://COOLW-PROVIDER-SERVICE/provider/hello", String.class).getBody();
    }
    ...
    public User getUser() {
        ...
        ResponseEntity<User> responseEntity = restTemplate.getForEntity("http://COOLW-PROVIDER-SERVICE/provider/getUser", User.class);
        return responseEntity.getBody();
    }

    @GetMapping("/consumer/hello3")
    public CommonResult<User> hello3() {
        CommonResult commonResult = restTemplate.postForEntity("http://COOLW-PROVIDER-SERVICE/provider/postHello", null, CommonResult.class).getBody();
        return commonResult;
    }
